...
2) Download word vectors, Universal Sentence Encoder and parse, see more in the resources Readme file:
```
./resources/preprocess.sh
```

## Preparing data & training the attacked models
### Pretrained models and parsed datasets
Use the following bash script to download all trained models and datasets

* if using the pre-trained models and datasets, the next stage can be skipped. 
